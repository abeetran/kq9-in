...
class M_deliveries extends CI_Model {
	...
	public function getdata(){
		$this->db->select('d.*, o.order_code, o.uu_tien, o.images, o.order_date')->from('obi_orders_deliveries d')->join('obi_orders o', 'o.id = d.order_id','inner')->where(array('o.trash'=>0,'o.status'=>3));
		$this->db->order_by('o.uu_tien','desc');
		$this->db->order_by('d.order_id','desc');
		$get = $this->db->get();
		if($get->num_rows() == 0){
			return FALSE;
		}
