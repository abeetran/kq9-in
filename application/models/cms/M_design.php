...
class M_design extends CI_Model {
	...
	public function getdata(){
		$this->db->select('d.*, o.order_code, o.uu_tien, o.images, o.order_date')->from('obi_orders_design d')->join('obi_orders o', 'o.id = d.order_id','inner')->where(array('o.trash'=>0,'o.status'=>1));
