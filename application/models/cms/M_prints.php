...
class M_prints extends CI_Model {
	...
	public function getdata(){
		$this->db->select('p.*, o.order_code, o.uu_tien, o.images, o.order_date')->from('obi_orders_prints p')->join('obi_orders o', 'o.id = p.order_id','inner')->where(array('o.trash'=>0,'o.status'=>2));
		$this->db->order_by('o.uu_tien','desc');
		$this->db->order_by('p.order_id','desc');
		$get = $this->db->get();
		if($get->num_rows() == 0){
			return FALSE;
		}
